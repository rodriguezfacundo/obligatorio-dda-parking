...
public class UITableroControl extends javax.swing.JFrame implements VistaTableroControl{
    ...
    public void mostrarListaParkings(ArrayList<Parking> parkings) {
        ...
        for (int i = 0; i < parkings.size(); i++) {
            ...
            modeloParkings.setValueAt(p.getTendencia().getNombre(), i, 3);
    ...
    @Override
    public void mostrarAnomaliasCheckbox(Estadia e) {
        DefaultTableModel modeloParkings = (DefaultTableModel) tb_anomalias.getModel();
            Object[] rowData = {
                e.getAnomalia().getFechaCreacion(),
                e.getVehiculo().getPropietario().getNombre(),
                e.getAnomalia().getCodigoError(),
                e.getCochera().getCodigo()
            };
            modeloParkings.addRow(rowData);
    }
